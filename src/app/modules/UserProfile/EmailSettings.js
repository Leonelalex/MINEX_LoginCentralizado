...
function EmailSettings(props) {
  ...
  // UI Helpers
  const initialValues = {
    emailNotification: user.emailSettings,
    sendCopyToPersonalEmail: user.emailSettings,
    youHaveNewNotifications:
      user.emailSettings,
    youAreSentADirectMessage:
      user.emailSettings,
    someoneAddsYouAsAsAConnection:
      user.emailSettings,
    uponNewOrder: user.emailSettings,
...
export default connect(null, null)(EmailSettings);
